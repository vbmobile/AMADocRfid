...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AMADocRFIDReadiOS",
            url: "https://vbmobileidstorage.blob.core.windows.net/ios/AMADocRFIDRead/AMADocRFIDReadiOS-3.2.0.zip",
            checksum: "947f24baf304cd3f446ab6cd03410ef1c00af0a272925b8d166e886237cdf02a"
        ),
        .target(
