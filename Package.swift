...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AMADocRFIDReadiOS",
            url: "https://vbmobileidstorage.blob.core.windows.net/ios/AMADocRfid/AMADocRFIDReadiOS-2.0.0.zip",
            checksum: "6242de16352b4179f0658da41b66fb712ebc9753227e02ea096c6b7f7407d3d5"
        ),
        .target(
